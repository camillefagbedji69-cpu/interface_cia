...
with st.sidebar:
    ...
    st.markdown("---")
    st.caption("💡 Ton code est au format : PRENOM2025")
...
if code:
    ...
    if not etudiant.empty:
        ...
        st.info("💡 Format attendu : PRENOM2025 (ex: JEAN2025)")
...
# ===== FOOTER =====
st.markdown("---")
st.caption("🤖 CIA-FA Dashboard • Développé avec ❤️ par FAGBEDJI Camille Boris")
st.caption('Dernière mise à jour le 20 mars 2026")
